...
Heart disease is one of the leading causes of death in the world. The data set for this study was obtained from [Kaggle](https://www.kaggle.com/code/tentotheminus9/what-causes-heart-disease-explaining-the-model/notebook). However, the primary goal of this report is not to develop a robust model to predict heart disease. The goal of this project is to create a report that is  easily reproducible utilizing the tools learned in the class and demonstrate mastery of the contents. Therefore, these results are not to be taken seriously in the context of heart disease research. 
